        ...
        try
        {
            ...
            if(identityResult.Succeeded) 
            {
                ...
                if(roleResult.Succeeded)
                {
                    ...
                    var confirmationLink = $"{_configuration.GetValue<string>("Url")}api/account/confirmemail?email={WebUtility.UrlEncode(identityUser.Email)}&token={WebUtility.UrlEncode(token)}";
